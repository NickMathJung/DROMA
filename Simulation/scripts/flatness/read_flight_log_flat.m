...
%     .estop .led .ack .flags   Mx1 uint8   (flags Bit0 Link weg, Bit1 Ring voll)
...
h.version    = u16(8);
assert(h.version == 2, ['Formatversion %d, dieser Leser erwartet 2. ' ...
       'v1 kannte die Reglerzustaende (k_hat/F/aint/ufb) noch nicht.'], h.version);
...
h.tick_last  = u32(44);
h.t_dump_ms  = u32(48);
assert(h.rec_fast == 12 && h.rec_slow == 74, ...
...
o = o + h.n_fast*12;
S = reshape(raw(o+1 : o+h.n_slow*74), 74, []).';   % M x 74 uint8
...
KHAT_SCALE = 20000; F_SCALE = 800; AINT_SCALE = 80; UFB_SCALE = 8; UFB_MAX = 700;
...
if any(bitand(log.flags, 2)), fprintf('  Hinweis: Ringpuffer war voll — aeltere Daten wurden ueberschrieben.\n'); end
