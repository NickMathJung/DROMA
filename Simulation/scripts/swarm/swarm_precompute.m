...
if ~isfield(cfg, 'agents') || isempty(cfg.agents)
    AG = {[], [1 1; 20 5], [1 1; 20 1; 1 5], [1 1; 20 1; 1 5; 20 5]};
...
% Stoerschaetzfehler v_d - v_d_hat und Stoerrichtung (Welt) fuer die Animation
G = res.params.G_arr(:, 1, 1);
G_w = [res.tf.R * G(1:2); G(3)];
