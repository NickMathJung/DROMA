...
% ihre Invarianten. Vor jedem Szenario 'clear safety_overspeed'.
%
% Deckt ab: Entprellung, Latch-Halt nach Ratenabfall, ack-Flanke statt Pegel,
% Re-Arm-Sperre, Hard-Kill, Kill-Vorrang vor Soft-Land, per-Achse gegen norm,
% Tilt-Cutoff und lokalen Taster-Kill.

% Tilt fuer die Overspeed-Szenarien deaktiviert
...
% Tilt-Cutoff: eigene Schwellen 80 deg / 4 Zyklen
...
a   = logical([0;0;0;0;0;0;0;1]); % ack-Flanke @8
...
% Quaternion fuer Kippwinkel deg um die Roll-Achse
a = deg2rad(deg);
