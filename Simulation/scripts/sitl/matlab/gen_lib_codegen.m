...
%  Je Funktion eine standalone C-Quelle, kein Build.
%
%  Speicherordnung: Coder legt Matrizen column-major ab. dcm2quat_local(R) erwartet
%  R daher column-major, quat2dcm_local(q) liefert R column-major.
%
%  Pfade:
...
cfg.TargetLang       = 'C';
cfg.GenCodeOnly      = true;      % nur Quelle, kein Compile
...
% Coder emittiert je <fn>_initialize()/<fn>()/<fn>_terminate().
...
%% ---- Nicht erzeugt ----
% geo_attitude_ctrl.m und mahony_filter.m liegen auf Modell-Ebene, safety_landcmd.m
% ist noch nicht als Leaf erzeugt.
